...
if __name__ == "__main__":
    ...
    like = SN_likelihood(r'data/Pantheon/full_long.dataset')
    ...
    like = SN_likelihood(r'data/jla.dataset', marginalize=False)
    zs = like.get_redshifts()
    start = time.time()
    ...
    like = SN_likelihood(r'data/jla.dataset', marginalize=True)
    zs = like.get_redshifts()
    start = time.time()
    chi2 = like.loglike(fit(zs)) * 2
    print('Likelihood execution time:', time.time() - start)
    ...
    like = SN_likelihood(r'data/jla.dataset', precompute_covmats=False, marginalize=True)
    zs = like.get_redshifts()
    start = time.time()
    chi2 = like.loglike(fit(zs)) * 2
    print('Likelihood execution time:', time.time() - start)
